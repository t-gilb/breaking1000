...
import Gradient from "@/components/element/gradient/Gradient";
import Marker from "@/components/element/marker/Marker";
...
const Profile = ({
  ...
  useEffect(() => {
    ...
    const highlightedCoordinates = [...new Array(coordinates.length)].map(
      () => [0, 0, 0]
    );
